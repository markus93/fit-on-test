...
python -u main_NN_1m_final.py -i $1 -ss $2 -s $3 --fit_pw --use_nn4 --use_ce_loss --use_sweep
python -u main_NN_1m_final.py -i $1 -ss $2 -s $3 --fit_pw --use_nn4 --use_sweep
python -u main_NN_1m_final.py -i $1 -ss $2 -s $3 --fit_pw --use_nn4 --use_ce_loss
python -u main_NN_1m_final.py -i $1 -ss $2 -s $3 --fit_pw --use_nn4
echo "Job finished"
