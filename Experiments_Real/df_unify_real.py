...
def get_strs(file, is_ece = True, is_kde = False, is_bip = False):
    ...
    pieces = file.split(".")[0].split("gt0_")
...
# "binning_CV_seed_0_1000_MSODIR_densenet40_c10gt0_dp_0.pkl"
# binning_CV_seed_0_10000_VecS_wide32_s7_tag_confidencegt1_dp_-1.pkl

    if is_ece:
        cal_method = parts1[5]
        data_name = "_".join(parts1[6:8])
        
        print(cal_method)
        print(data_name)

    #KDE_seed_0_1000_MSODIR_wide32_c100_dp_5.pkl
    elif is_kde:
        cal_method = parts1[4]
        data_name = "_".join(parts1[5:7])

        
        # df_seed_0_MSODIR_1000_cv_0_densenet40_c10gt0_dp_0_iso_beta_platt
    elif is_bip:
        cal_method = parts1[3]
        data_name = "_".join(parts1[7:9])
        
        n_data = int(parts1[4])
               
        # df_seed_0_MSODIR_1000_cv_0_densenet40_c10_dp_0_PW_NN4_MSE_sweep.pkl        
    else:
...
IDENT_TAG = "28_05_real"
PATH_res = "data_real_final_2705"
